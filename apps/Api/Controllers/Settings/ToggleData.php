<?php
/**
 * Toggle Settings API Controller.
 *
...
use WP_Error;
use QuickCartShopping\Helper\Sanitization\ToggleDataSanitization;

defined('ABSPATH') || exit;

/**
 * Toggle Settings REST API Controller
 */
class ToggleData extends WP_REST_Controller
{
    /**
     * Constructor.
     */
    public function __construct() {
        ...
        $this->rest_base = 'save-toggle-settings';
    }

    /**
     * Register the routes for Toggle Settings.
     *
     * @return void
     */
    public function register_routes()
    {
        ...
        register_rest_route(
            $this->namespace,
            '/update-toggle-settings/(?P<id>[a-zA-Z0-9_-]+)',
            [
                [
