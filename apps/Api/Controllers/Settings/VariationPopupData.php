<?php
/**
 * Variation Popup Settings REST API Controller.
 *
...
use WP_Error;
use QuickCartShopping\Helper\Sanitization\VariationPopupDataSanitization;
 ...
 * Variation Popup Settings REST API Controller
 */
class VariationPopupData extends WP_REST_Controller
{
    /**
     * Constructor.
     */
    public function __construct() {
        ...
        $this->rest_base = 'save-variation-popup-settings';
    }

    /**
     * Register the routes for Variation Popup Settings.
     *
     * @return void
     */
    public function register_routes()
    {
        ...
        register_rest_route(
            $this->namespace,
            '/update-variation-popup-settings/(?P<id>[a-zA-Z0-9_-]+)',
            [
                [
    ...
    /**
     * Save variation popup settings data.
     *
     * @param WP_REST_Request $request The request object.
    ...
    public function save_form_data( WP_REST_Request $request )
    {
        ...
        $sanitized_data = VariationPopupDataSanitization::sanitize_variation_popup_settings( $params );

        $saved = update_option( 'qcshopping_variation_popup_settings', $sanitized_data );
    ...
    /**
     * Get variation popup settings data.
     *
     * @param WP_REST_Request $request The request object.
     * @return WP_REST_Response The response object.
     */
    ...
    {
        $raw = get_option( 'qcshopping_variation_popup_settings', [] );
    ...
    /**
     * Update variation popup settings data.
     *
     * @param WP_REST_Request $request The request object.
     * @return WP_REST_Response The response object.
     */
    public function update_form_data( WP_REST_Request $request )
    {
        ...
        $existing = get_option( 'qcshopping_variation_popup_settings', [] );
        ...
        $sanitized_data = VariationPopupDataSanitization::sanitize_variation_popup_settings( $merged );

        $updated = update_option( 'qcshopping_variation_popup_settings', $sanitized_data );
